...
var TradingSessionStatusEntryCollection = mongoose.model('session-status-entries', tradingSessionStatusEntrySchema);
//export default  RefreshTokenModelCollection;
/*module.exports = {
    RefreshTokenModelCollection: mongoose.model('refresh-tokens', refreshTokenSchema)
}*/
exports.default = TradingSessionStatusEntryCollection;
